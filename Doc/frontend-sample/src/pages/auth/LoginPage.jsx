    ...
    <div className="flex h-screen w-full bg-background-dark">
      ...
      <div ref={rightPanelRef} className="flex-1 flex items-center justify-center p-8 bg-background-dark">
        <div className="w-full max-w-[420px] panel panel-glow p-8">
          ...
          <h2 className="animate-me text-2xl font-semibold text-slate-100">Welcome back</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="animate-me mt-2 w-full h-11 bg-primary hover:bg-primary/90 disabled:opacity-70 disabled:cursor-not-allowed text-[#071018] rounded-full font-semibold text-sm transition-all flex items-center justify-center gap-2 shadow-[0_12px_30px_-18px_rgba(76,201,240,0.8)]"
            >
              {loading ? (
                <>
