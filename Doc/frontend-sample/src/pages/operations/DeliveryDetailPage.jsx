  ...
  return (
    ...
    >
      ...
      <div className="panel mb-6 overflow-hidden">
        <div className="px-6 py-4 flex items-center justify-between border-b border-white/10 gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap justify-end">
            ...
            {!isNew && ['draft', 'waiting'].includes(delivery?.status) && (
              <button
                ...
                className="btn-ghost px-4 py-2 text-sm text-primary"
              >
                Mark Ready
              </button>
            )}
            ...
            {!isNew && delivery?.status === 'ready' && (
              <button
                ...
                className="rounded-xl border border-emerald-500/40 px-4 py-2 text-sm font-semibold text-emerald-300 hover:bg-emerald-500/10"
              >
                Validate
              </button>
            )}
            ...
            {!isNew && ['draft', 'waiting', 'ready'].includes(delivery?.status) && (
              <button
                ...
                className="rounded-xl border border-rose-500/30 px-4 py-2 text-sm font-semibold text-rose-300 hover:bg-rose-500/10"
              >
                Cancel
              </button>
            )}
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div key={step} className="flex items-center gap-4 min-w-fit">
                ...
                {index < steps.length - 1 && <div className="h-px w-12 bg-white/10" />}
              </div>
            )
          })}
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="panel p-5">
              ...
              <div className="overflow-x-auto">
                        ...
                        >
                          ...
                          <td className="px-4 py-3">
                            <input
                              ...
                              className={`w-24 bg-white/5 border rounded-xl px-3 py-2 text-sm text-slate-100 focus:outline-none focus:border-primary disabled:opacity-70 ${isOutOfStock ? 'border-rose-500/50' : 'border-white/10'}`}
                            />
                          </td>
                          <td className="px-4 py-3">
                            {!line.product_id ? (
                ...
                <div className="border-t border-white/10 pt-4 mt-3 flex justify-end items-center">
