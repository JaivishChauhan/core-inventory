  ...
  return (
    <AppShell breadcrumbs={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'Move History', href: '/history' }]}>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-slate-100">Stock Move History</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={loadHistory}
            className="btn-ghost text-sm py-2 px-4 rounded-full"
          >
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="bg-white/5 border border-white/10 rounded-xl py-1.5 pl-9 pr-4 text-sm focus:outline-none focus:border-primary/60 focus:ring-2 focus:ring-primary/20 text-slate-100 placeholder:text-slate-600 w-[240px]"
            />
          </div>
