    ...
    <AppShell breadcrumbs={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'Products', href: '/products' }]}>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <div className="hidden lg:flex items-center gap-3 text-[11px] text-slate-700 mt-2">
      ...
      <div className="panel p-4 flex flex-wrap items-center gap-4 mb-4">
        <div className="relative max-w-[300px] w-full">
          ...
          <input
            ...
            className="w-full py-2 pl-10 pr-4 text-sm rounded-xl bg-white/5 border border-white/10 focus:border-primary/60 focus:ring-2 focus:ring-primary/30 placeholder:text-slate-600"
          />
        </div>
        ...
        <div className="flex gap-2 flex-wrap">
          <select
            ...
            className="bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm font-medium text-slate-300 focus:outline-none hover:border-primary/30 cursor-pointer"
          >
      ...
      {!loading && products.length === 0 ? (
        ...
        <div className="overflow-hidden rounded-2xl border border-border/70 bg-[#0f1426] mb-6 relative">
                        ...
                        <td className="px-4 py-4 text-right">
                          <div className="flex justify-end gap-2">
                            <button
                              ...
                              className="rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs text-slate-300 hover:border-primary/40 hover:text-white"
                            >
                              Edit
                            </button>
                            <button
                              ...
                              className="rounded-full border border-rose-500/30 bg-rose-500/10 px-3 py-1.5 text-xs text-rose-300 hover:bg-rose-500/20 disabled:opacity-60"
                            >
