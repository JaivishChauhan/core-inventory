  ...
  return (
    <AppShell breadcrumbs={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'Operations', href: '#' }, { label: 'Adjustments', href: '/operations/adjustment' }]}>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[360px_1fr] gap-5">
        <form onSubmit={handleSubmit} className="bg-[#161B22] border border-slate-800 rounded-xl p-5 h-fit">
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <select
                ...
                className="mt-1.5 w-full bg-slate-900 border border-slate-800 rounded-lg px-3 py-2.5 text-sm text-slate-100 focus:outline-none focus:border-primary"
                required
              >
            ...
            <div>
              ...
              <textarea
                ...
                className="mt-1.5 w-full resize-y bg-slate-900 border border-slate-800 rounded-lg px-3 py-2.5 text-sm text-slate-100 focus:outline-none focus:border-primary"
            ...
            <button
              type="submit"
              disabled={saving}
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-semibold text-white hover:bg-primary/90 disabled:opacity-70"
            >
