                        ...
                        <tr key={`${line.product_id}-${index}`} className="hover:bg-slate-800/30 transition-colors">
                          ...
                          <td className="px-4 py-3">
                            <input
                              ...
                              className="w-24 bg-slate-900 border border-slate-800 rounded-lg px-3 py-2 text-sm text-slate-100 focus:outline-none focus:border-primary disabled:opacity-70"
                            />
                          </td>
                ...
                <div className="flex flex-col gap-4 relative">
                  ...
                  {receipt.activity.map((entry) => (
                    <div key={entry.id} className="flex gap-4 relative z-10">
                      <div className="w-2 h-2 rounded-full bg-emerald-400 mt-1.5 shrink-0 shadow-[0_0_0_4px_#161B22]" />
                      <div className="flex flex-col">
