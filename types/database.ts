  ...
  public: {
    Tables: {
      ...
      stock_moves: {
        ...
        Relationships: [
          {
            foreignKeyName: "stock_moves_dest_location_id_fkey"
    ...
    Enums: {
      location_type: "internal" | "vendor" | "customer" | "loss"
      move_status: "draft" | "waiting" | "ready" | "done" | "canceled"
      move_type: "receipt" | "delivery" | "internal_transfer" | "adjustment"
    }
    CompositeTypes: {
      [_ in never]: never
    }
